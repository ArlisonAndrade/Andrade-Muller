...
// Receitas somam, despesas subtraem — mesmo princípio do PRD (categoria.tipo define o sinal).
...
export function valorInvestido(
...
export function patrimonio(
  ...
  return (
    saldoContas(contas) + fluxoTransacoes(transacoes) + valorInvestido(posicoes, cotacoes)
  );
}
